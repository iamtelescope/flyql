...
description: Wie man flyql-Diagnosen und Parser-Fehler liest
---
...
flyql liefert eine einzige Registry aller Diagnose-Codes und Parser-Errnos. Die Registry ist die maßgebliche Quelle, die Python, JavaScript und Go synchron hält, und jeder `Diagnostic` oder Parser-Fehler, den ein Consumer sieht, trägt einen optionalen Verweis darauf.
...
## Codes mit dynamischen Nachrichten
