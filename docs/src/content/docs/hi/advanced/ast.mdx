...
| `valueType` | `string` या `null` | `value` का स्पष्ट प्रकार: `"integer"`, `"bigint"`, `"float"`, `"string"`, `"boolean"`, `"null"`, `"function"`, या `"parameter"`। <FlyqlToken type="operator">in</FlyqlToken>/<FlyqlToken type="operator">not in</FlyqlToken> के लिए `null`। |
