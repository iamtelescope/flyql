...
description: Comment lire les diagnostics et erreurs du parser flyql
---
...
flyql livre un registre unique de chaque code de diagnostic et errno de parser. Le registre est la source de vérité qui garde Python, JavaScript et Go synchronisés, et chaque `Diagnostic` ou erreur de parser qu'un consommateur voit contient une référence optionnelle vers lui.
