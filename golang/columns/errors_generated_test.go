...
var generatedColumnsParserConstants = map[string]int{
	"COLUMNS_ERR_UNKNOWN_STATE":                         columnsErrUnknownState,
	...
	"COLUMNS_ERR_INVALID_CHAR_IN_QUOTED_ARG":            columnsErrInvalidCharInQuotedArg,
	"COLUMNS_ERR_RENDERERS_NOT_ENABLED_OR_NO_ALIAS":     columnsErrRenderersNotEnabledOrNoAlias,
