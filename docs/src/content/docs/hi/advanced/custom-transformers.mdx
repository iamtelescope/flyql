...
| `inputType` | TransformerType | अपेक्षित इनपुट प्रकार (`string`, `int`, `float`, `bool`, `array`) |
| `outputType` | TransformerType | ट्रांसफ़ॉर्मेशन के बाद आउटपुट प्रकार |
...
|--------|------|----------|-------------|
| `type` | TransformerType | — | अपेक्षित आर्गुमेंट प्रकार (`string`, `int`, `float`, `bool`) |
