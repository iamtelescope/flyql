...
Der [Tokenizer](./tokenize) ist ein gemeinsames Primitiv, das die zeichenweise Ausgabe des Parsers zu typisierten Tokens mit `{text, type, start, end}` zusammenfasst. Nutze ihn, um eigene Highlighter oder Formatter auf Basis von FlyQL zu bauen.
