...
var generatedCoreParserConstants = map[string]int{
	"ERR_UNKNOWN_STATE":                        errUnknownState,
	...
	"ERR_INVALID_CHAR_OR_UNKNOWN_OPERATOR":     errInvalidCharOrUnknownOperator,
	"ERR_INVALID_CHAR_IN_QUOTED_VALUE":         errInvalidCharInQuotedValue,
	...
	"ERR_EXPECTED_OPERATOR_OR_UNCLOSED_STRING": errExpectedOperatorOrUnclosedString,
	"ERR_EXPECTED_VALUE":                       errExpectedValue,
	"ERR_INVALID_CHAR_IN_SINGLE_QUOTED_KEY":    errInvalidCharInSingleQuotedKey,
	"ERR_INVALID_CHAR_IN_DOUBLE_QUOTED_KEY":    errInvalidCharInDoubleQuotedKey,
	...
	"ERR_INVALID_CHAR_IN_LIST_QUOTED_VALUE":    errInvalidCharInListQuotedValue,
	"ERR_EXPECTED_COMMA_OR_LIST_END":           errExpectedCommaOrListEnd,
	"ERR_EXPECTED_LIST_START_AFTER_IN":         errExpectedListStartAfterIn,
	"ERR_EXPECTED_VALUE_OR_KEYWORD":            errExpectedValueOrKeyword,
