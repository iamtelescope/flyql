...
description: Como ler diagnósticos e erros do parser flyql
---
...
O flyql traz um registro único de cada código de diagnóstico e errno do parser. O registro é a fonte da verdade que mantém Python, JavaScript e Go sincronizados, e cada `Diagnostic` ou erro do parser que um consumidor vê carrega uma referência opcional a ele.
