...
var generatedValidatorRegistry = map[string]ErrorEntry{
	...
	"CODE_UNKNOWN_COLUMN":                 {Code: CodeUnknownColumn, Name: "CODE_UNKNOWN_COLUMN", Message: "unknown column", Description: "The referenced column does not exist in the supplied schema. Check for typos or use a column registered on the schema.", DynamicMessage: false},
