...
export const ERR_UNKNOWN_STATE = 1
...
export const ERR_INVALID_CHAR_OR_UNKNOWN_OPERATOR = 10
export const ERR_INVALID_CHAR_IN_QUOTED_VALUE = 11
...
export const ERR_EXPECTED_OPERATOR_OR_UNCLOSED_STRING = 28
export const ERR_EXPECTED_VALUE = 29
export const ERR_INVALID_CHAR_IN_SINGLE_QUOTED_KEY = 30
export const ERR_INVALID_CHAR_IN_DOUBLE_QUOTED_KEY = 31
...
export const ERR_INVALID_CHAR_IN_LIST_QUOTED_VALUE = 45
export const ERR_EXPECTED_COMMA_OR_LIST_END = 46
export const ERR_EXPECTED_LIST_START_AFTER_IN = 47
export const ERR_EXPECTED_VALUE_OR_KEYWORD = 50
...
export const CORE_PARSER_MESSAGES = Object.freeze({
    [ERR_UNKNOWN_STATE]: 'unknown parser state',
    ...
    [ERR_INVALID_CHAR_OR_UNKNOWN_OPERATOR]: 'invalid character or unknown operator',
    [ERR_INVALID_CHAR_IN_QUOTED_VALUE]: 'invalid character',
    ...
    [ERR_EXPECTED_OPERATOR_OR_UNCLOSED_STRING]: 'expected operator or unclosed string',
    [ERR_EXPECTED_VALUE]: 'expected value',
    [ERR_INVALID_CHAR_IN_SINGLE_QUOTED_KEY]: 'invalid character in quoted key',
    [ERR_INVALID_CHAR_IN_DOUBLE_QUOTED_KEY]: 'invalid character in quoted key',
    ...
    [ERR_INVALID_CHAR_IN_LIST_QUOTED_VALUE]: 'invalid character in quoted value',
    [ERR_EXPECTED_COMMA_OR_LIST_END]: "expected ',' or ']'",
    [ERR_EXPECTED_LIST_START_AFTER_IN]: "expected '[' after 'in'",
    [ERR_EXPECTED_VALUE_OR_KEYWORD]: 'expected value or keyword',
...
export const COLUMNS_ERR_UNKNOWN_STATE = 1
...
export const COLUMNS_ERR_INVALID_CHAR_IN_QUOTED_ARG = 10
export const COLUMNS_ERR_RENDERERS_NOT_ENABLED_OR_NO_ALIAS = 11
...
export const COLUMNS_PARSER_MESSAGES = Object.freeze({
    [COLUMNS_ERR_UNKNOWN_STATE]: 'unknown state',
    ...
    [COLUMNS_ERR_INVALID_CHAR_IN_QUOTED_ARG]: 'invalid character',
    [COLUMNS_ERR_RENDERERS_NOT_ENABLED_OR_NO_ALIAS]: 'renderers not enabled or missing alias',
