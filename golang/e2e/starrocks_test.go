...
func TestStarRocksJoinE2E(t *testing.T) {
	dsn := starRocksDSN()
	...
	columns := loadStarRocksJoinColumns(t)
...
func TestStarRocksJoinSelectE2E(t *testing.T) {
	dsn := starRocksDSN()
	...
	columns := loadStarRocksJoinColumns(t)
	testCases := loadJoinSelectTestCases(t, "starrocks")
