...
O [tokenizador](./tokenize) é uma primitiva compartilhada que agrupa a saída caractere a caractere do parser em tokens tipados com a forma `{text, type, start, end}`. Use-o para construir realçadores ou formatadores customizados sobre o FlyQL.
