...
El [tokenizador](./tokenize) es una primitiva compartida que agrupa la salida por carácter del parser en tokens tipados con `{text, type, start, end}`. Úsalo para construir resaltadores o formateadores personalizados sobre FlyQL.
