...
from flyql.generators.postgresql import Column, to_sql_select
from flyql.generators.postgresql.generator import _to_key_transformers
...
def test_to_sql_select_renderer_suffix(
    ...
    cols = {"message": Column(name="message", _type="text")}
