...
description: Cómo leer diagnósticos y errores del parser de flyql
---
...
flyql incluye un registro único de todos los códigos de diagnóstico y errnos del parser. El registro es la única fuente de verdad que mantiene Python, JavaScript y Go sincronizados, y cada `Diagnostic` o error del parser que ve un consumidor lleva una referencia opcional a él.
