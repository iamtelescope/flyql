...
| Validate | `Diagnose(columns)` | `diagnose(columns)` | `diagnose(columns)` |
| **Types** | | | |
...
| Operation | Go | Python | JavaScript |
|-----------|------|--------|------------|
| Diagnose AST | `Diagnose(root, columns)` | `diagnose(root, columns)` | `diagnose(root, columns)` |
| **Types** | | | |
| Diagnostic | `Diagnostic` | `Diagnostic` | `Diagnostic` |

## Top-Level Package Imports

**Python** — `from flyql import parse, Node, Expression, Key, Column, Operator, Range, Diagnostic, diagnose, ValueType`

**JavaScript** — `import { parse, Node, Expression, Key, Column, Operator, Range, ValueType } from 'flyql'`
