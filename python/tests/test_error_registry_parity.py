...
) -> Iterator[tuple[str, str, object, str, bool]]:
    """Yield (category, name, expected_value, message, dynamic_message) tuples."""
...
@pytest.mark.parametrize("category,name,expected,message,dynamic", CASES)
def test_constant_value(
    category: str, name: str, expected: object, message: str, dynamic: bool
) -> None:
    assert hasattr(
