...
O [tokenizador](./tokenize) é uma primitiva partilhada que agrupa a saída carácter a carácter do parser em tokens tipados com a forma `{text, type, start, end}`. Use-o para construir realçadores ou formatadores personalizados sobre o FlyQL.
