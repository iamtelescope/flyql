...
[टोकनाइज़र](./tokenize) एक साझा प्रिमिटिव है जो parser के प्रति-अक्षर आउटपुट को `{text, type, start, end}` आकार के टाइप किए गए टोकनों में समूहित करता है। FlyQL के ऊपर कस्टम हाइलाइटर या फ़ॉर्मेटर बनाने के लिए इसका उपयोग करें।
