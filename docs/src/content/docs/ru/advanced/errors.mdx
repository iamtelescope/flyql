...
description: Как читать диагностики и ошибки парсера flyql
---
...
flyql поставляет единый реестр всех диагностических кодов и errno парсера. Реестр -- единственный источник истины, который держит Python, JavaScript и Go синхронизированными, и каждый `Diagnostic` или ошибка парсера, которые видит потребитель, несут опциональную ссылку на него.
...
## Коды с динамическим сообщением
