...
class ParserError(FlyqlError):
    def __init__(self, message: str, errno: int, help_text: str = ""):
            ...
            if (
                ...
                if self.bool_operator in VALID_BOOL_OPERATORS:
                    ...
                    if len(self.text) > next_pos:
                        next_char = Char(self.text[next_pos], next_pos)
    ...
    def parse(self, text: str) -> None:
        ...
        if self.state == State.ERROR:
            raise ParserError(
                ...
                errno=self.errno,
                help_text=self.error_help_text,
            )
